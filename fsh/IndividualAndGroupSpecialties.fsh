...
* $NUCCProviderTaxonomy#204D00000X "Neuromusculoskeletal Medicine & OMM"
* $NUCCProviderTaxonomy#204E00000X "Oral & Maxillofacial Surgery (D.M.D.)"
* $NUCCProviderTaxonomy#204F00000X "Transplant Surgery"
* $NUCCProviderTaxonomy#204R00000X "Electrodiagnostic Medicine"
* $NUCCProviderTaxonomy#207K00000X "Allergy & Immunology"
* $NUCCProviderTaxonomy#207KA0200X "Allergy"
* $NUCCProviderTaxonomy#207KI0005X "Clinical & Laboratory Immunology (Allergy & Immunology)"
* $NUCCProviderTaxonomy#207L00000X "Anesthesiology"
* $NUCCProviderTaxonomy#207LA0401X "Addiction Medicine (Anesthesiology)"
* $NUCCProviderTaxonomy#207LC0200X "Critical Care Medicine (Anesthesiology)"
* $NUCCProviderTaxonomy#207LH0002X "Hospice and Palliative Medicine (Anesthesiology)"
* $NUCCProviderTaxonomy#207LP2900X "Pain Medicine (Anesthesiology)"
* $NUCCProviderTaxonomy#207LP3000X "Pediatric Anesthesiology"
* $NUCCProviderTaxonomy#207N00000X "Dermatology"
* $NUCCProviderTaxonomy#207ND0101X "MOHS-Micrographic Surgery"
* $NUCCProviderTaxonomy#207ND0900X "Dermatopathology"
* $NUCCProviderTaxonomy#207NI0002X "Clinical & Laboratory Dermatological Immunology"
* $NUCCProviderTaxonomy#207NP0225X "Pediatric Dermatology"
* $NUCCProviderTaxonomy#207NS0135X "Procedural Dermatology"
* $NUCCProviderTaxonomy#207P00000X "Emergency Medicine"
* $NUCCProviderTaxonomy#207PE0004X "Emergency Medical Services (Emergency Medicine)"
* $NUCCProviderTaxonomy#207PE0005X "Undersea and Hyperbaric Medicine (Emergency Medicine)"
* $NUCCProviderTaxonomy#207PH0002X "Hospice and Palliative Medicine (Emergency Medicine)"
* $NUCCProviderTaxonomy#207PP0204X "Pediatric Emergency Medicine (Emergency Medicine)"
* $NUCCProviderTaxonomy#207PS0010X "Sports Medicine (Emergency Medicine)"
* $NUCCProviderTaxonomy#207PT0002X "Medical Toxicology (Emergency Medicine)"
* $NUCCProviderTaxonomy#207Q00000X "Family Medicine"
* $NUCCProviderTaxonomy#207QA0000X "Adolescent Medicine (Family Medicine)"
* $NUCCProviderTaxonomy#207QA0401X "Addiction Medicine (Family Medicine)"
* $NUCCProviderTaxonomy#207QA0505X "Adult Medicine"
* $NUCCProviderTaxonomy#207QB0002X "Obesity Medicine (Family Medicine)"
* $NUCCProviderTaxonomy#207QG0300X "Geriatric Medicine (Family Medicine)"
* $NUCCProviderTaxonomy#207QH0002X "Hospice and Palliative Medicine (Family Medicine)"
* $NUCCProviderTaxonomy#207QS0010X "Sports Medicine (Family Medicine)"
* $NUCCProviderTaxonomy#207QS1201X "Sleep Medicine (Family Medicine)"
* $NUCCProviderTaxonomy#207R00000X "Internal Medicine"
* $NUCCProviderTaxonomy#207RA0000X "Adolescent Medicine (Internal Medicine)"
* $NUCCProviderTaxonomy#207RA0001X "Advanced Heart Failure and Transplant Cardiology"
* $NUCCProviderTaxonomy#207RA0002X "Adult Congenital Heart Disease"
* $NUCCProviderTaxonomy#207RA0201X "Allergy & Immunology (Internal Medicine)"
* $NUCCProviderTaxonomy#207RA0401X "Addiction Medicine (Internal Medicine)"
* $NUCCProviderTaxonomy#207RB0002X "Obesity Medicine (Internal Medicine)"
* $NUCCProviderTaxonomy#207RC0000X "Cardiovascular Disease"
* $NUCCProviderTaxonomy#207RC0001X "Clinical Cardiac Electrophysiology"
* $NUCCProviderTaxonomy#207RC0200X "Critical Care Medicine (Internal Medicine)"
* $NUCCProviderTaxonomy#207RE0101X "Endocrinology, Diabetes & Metabolism"
* $NUCCProviderTaxonomy#207RG0100X "Gastroenterology"
* $NUCCProviderTaxonomy#207RG0300X "Geriatric Medicine (Internal Medicine)"
* $NUCCProviderTaxonomy#207RH0000X "Hematology (Internal Medicine)"
* $NUCCProviderTaxonomy#207RH0002X "Hospice and Palliative Medicine (Internal Medicine)"
* $NUCCProviderTaxonomy#207RH0003X "Hematology & Oncology"
* $NUCCProviderTaxonomy#207RH0005X "Hypertension Specialist"
* $NUCCProviderTaxonomy#207RI0001X "Clinical & Laboratory Immunology (Internal Medicine)"
* $NUCCProviderTaxonomy#207RI0008X "Hepatology"
* $NUCCProviderTaxonomy#207RI0011X "Interventional Cardiology"
* $NUCCProviderTaxonomy#207RI0200X "Infectious Disease"
* $NUCCProviderTaxonomy#207RM1200X "Magnetic Resonance Imaging (MRI) Internal Medicine"
* $NUCCProviderTaxonomy#207RN0300X "Nephrology"
* $NUCCProviderTaxonomy#207RP1001X "Pulmonary Disease"
* $NUCCProviderTaxonomy#207RR0500X "Rheumatology"
* $NUCCProviderTaxonomy#207RS0010X "Sports Medicine (Internal Medicine)"
* $NUCCProviderTaxonomy#207RS0012X "Sleep Medicine (Internal Medicine)"
* $NUCCProviderTaxonomy#207RT0003X "Transplant Hepatology"
* $NUCCProviderTaxonomy#207RX0202X "Medical Oncology"
* $NUCCProviderTaxonomy#207SC0300X "Clinical Cytogenetics"
* $NUCCProviderTaxonomy#207SG0201X "Clinical Genetics (M.D.)"
* $NUCCProviderTaxonomy#207SG0202X "Clinical Biochemical Genetics"
* $NUCCProviderTaxonomy#207SG0203X "Clinical Molecular Genetics"
* $NUCCProviderTaxonomy#207SG0205X "Ph.D. Medical Genetics"
* $NUCCProviderTaxonomy#207SM0001X "Molecular Genetic Pathology (Medical Genetics)"
* $NUCCProviderTaxonomy#207T00000X "Neurological Surgery"
* $NUCCProviderTaxonomy#207U00000X "Nuclear Medicine"
* $NUCCProviderTaxonomy#207UN0901X "Nuclear Cardiology"
* $NUCCProviderTaxonomy#207UN0902X "Nuclear Imaging & Therapy"
* $NUCCProviderTaxonomy#207UN0903X "In Vivo & In Vitro Nuclear Medicine"
* $NUCCProviderTaxonomy#207V00000X "Obstetrics & Gynecology"
* $NUCCProviderTaxonomy#207VB0002X "Obesity Medicine (Obstetrics & Gynecology)"
* $NUCCProviderTaxonomy#207VC0200X "Critical Care Medicine (Obstetrics & Gynecology)"
* $NUCCProviderTaxonomy#207VE0102X "Reproductive Endocrinology"
* $NUCCProviderTaxonomy#207VF0040X "Female Pelvic Medicine and Reconstructive Surgery (Obstetrics & Gynecology)"
* $NUCCProviderTaxonomy#207VG0400X "Gynecology"
* $NUCCProviderTaxonomy#207VH0002X "Hospice and Palliative Medicine (Obstetrics & Gynecology)"
* $NUCCProviderTaxonomy#207VM0101X "Maternal & Fetal Medicine"
* $NUCCProviderTaxonomy#207VX0000X "Obstetrics"
* $NUCCProviderTaxonomy#207VX0201X "Gynecologic Oncology"
* $NUCCProviderTaxonomy#207W00000X "Ophthalmology"
* $NUCCProviderTaxonomy#207WX0009X "Glaucoma Specialist (Ophthalmology)"
* $NUCCProviderTaxonomy#207WX0107X "Retina Specialist (Ophthalmology)"
* $NUCCProviderTaxonomy#207WX0108X "Uveitis and Ocular Inflammatory Disease (Ophthalmology)"
* $NUCCProviderTaxonomy#207WX0109X "Neuro-ophthalmology"
* $NUCCProviderTaxonomy#207WX0110X "Pediatric Ophthalmology and Strabismus Specialist"
* $NUCCProviderTaxonomy#207WX0120X "Cornea and External Diseases Specialist"
* $NUCCProviderTaxonomy#207WX0200X "Ophthalmic Plastic and Reconstructive Surgery"
* $NUCCProviderTaxonomy#207X00000X "Orthopaedic Surgery"
* $NUCCProviderTaxonomy#207XP3100X "Pediatric Orthopaedic Surgery"
* $NUCCProviderTaxonomy#207XS0106X "Orthopaedic Hand Surgery"
* $NUCCProviderTaxonomy#207XS0114X "Adult Reconstructive Orthopaedic Surgery"
* $NUCCProviderTaxonomy#207XS0117X "Orthopaedic Surgery of the Spine"
* $NUCCProviderTaxonomy#207XX0004X "Orthopaedic Foot and Ankle Surgery"
* $NUCCProviderTaxonomy#207XX0005X "Sports Medicine (Orthopaedic Surgery)"
* $NUCCProviderTaxonomy#207XX0801X "Orthopaedic Trauma"
* $NUCCProviderTaxonomy#207Y00000X "Otolaryngology"
* $NUCCProviderTaxonomy#207YP0228X "Pediatric Otolaryngology"
* $NUCCProviderTaxonomy#207YS0012X "Sleep Medicine (Otolaryngology)"
* $NUCCProviderTaxonomy#207YS0123X "Facial Plastic Surgery"
* $NUCCProviderTaxonomy#207YX0007X "Plastic Surgery within the Head & Neck (Otolaryngology)"
* $NUCCProviderTaxonomy#207YX0602X "Otolaryngic Allergy"
* $NUCCProviderTaxonomy#207YX0901X "Otology & Neurotology"
* $NUCCProviderTaxonomy#207YX0905X "Otolaryngology/Facial Plastic Surgery"
* $NUCCProviderTaxonomy#207ZB0001X "Blood Banking & Transfusion Medicine"
* $NUCCProviderTaxonomy#207ZC0006X "Clinical Pathology"
* $NUCCProviderTaxonomy#207ZC0008X "Clinical Informatics (Pathology)"
* $NUCCProviderTaxonomy#207ZC0500X "Cytopathology"
* $NUCCProviderTaxonomy#207ZD0900X "Dermatopathology (Pathology)"
* $NUCCProviderTaxonomy#207ZF0201X "Forensic Pathology"
* $NUCCProviderTaxonomy#207ZH0000X "Hematology (Pathology)"
* $NUCCProviderTaxonomy#207ZI0100X "Immunopathology"
* $NUCCProviderTaxonomy#207ZM0300X "Medical Microbiology"
* $NUCCProviderTaxonomy#207ZN0500X "Neuropathology"
* $NUCCProviderTaxonomy#207ZP0007X "Molecular Genetic Pathology (Pathology)"
* $NUCCProviderTaxonomy#207ZP0101X "Anatomic Pathology"
* $NUCCProviderTaxonomy#207ZP0102X "Anatomic Pathology & Clinical Pathology"
* $NUCCProviderTaxonomy#207ZP0104X "Chemical Pathology"
* $NUCCProviderTaxonomy#207ZP0105X "Clinical Pathology/Laboratory Medicine"
* $NUCCProviderTaxonomy#207ZP0213X "Pediatric Pathology"
* $NUCCProviderTaxonomy#208000000X "Pediatrics"
* $NUCCProviderTaxonomy#2080A0000X "Pediatric Adolescent Medicine"
* $NUCCProviderTaxonomy#2080B0002X "Pediatric Obesity Medicine"
* $NUCCProviderTaxonomy#2080C0008X "Child Abuse Pediatrics"
* $NUCCProviderTaxonomy#2080H0002X "Pediatric Hospice and Palliative Medicine"
* $NUCCProviderTaxonomy#2080I0007X "Pediatric Clinical & Laboratory Immunology"
* $NUCCProviderTaxonomy#2080N0001X "Neonatal-Perinatal Medicine"
* $NUCCProviderTaxonomy#2080P0006X "Developmental – Behavioral Pediatrics"
* $NUCCProviderTaxonomy#2080P0008X "Pediatric Neurodevelopmental Disabilities"
* $NUCCProviderTaxonomy#2080P0201X "Pediatric Allergy/Immunology"
* $NUCCProviderTaxonomy#2080P0202X "Pediatric Cardiology"
* $NUCCProviderTaxonomy#2080P0203X "Pediatric Critical Care Medicine"
* $NUCCProviderTaxonomy#2080P0204X "Pediatric Emergency Medicine (Pediatrics)"
* $NUCCProviderTaxonomy#2080P0205X "Pediatric Endocrinology"
* $NUCCProviderTaxonomy#2080P0206X "Pediatric Gastroenterology"
* $NUCCProviderTaxonomy#2080P0207X "Pediatric Hematology & Oncology"
* $NUCCProviderTaxonomy#2080P0208X "Pediatric Infectious Diseases"
* $NUCCProviderTaxonomy#2080P0210X "Pediatric Nephrology"
* $NUCCProviderTaxonomy#2080P0214X "Pediatric Pulmonology"
* $NUCCProviderTaxonomy#2080P0216X "Pediatric Rheumatology"
* $NUCCProviderTaxonomy#2080S0010X "Pediatric Sports Medicine"
* $NUCCProviderTaxonomy#2080S0012X "Pediatric Sleep Medicine"
* $NUCCProviderTaxonomy#2080T0002X "Pediatric Medical Toxicology"
* $NUCCProviderTaxonomy#2080T0004X "Pediatric Transplant Hepatology"
* $NUCCProviderTaxonomy#208100000X "Physical Medicine & Rehabilitation"
* $NUCCProviderTaxonomy#2081H0002X "Hospice and Palliative Medicine (Physical Medicine & Rehabilitation)"
* $NUCCProviderTaxonomy#2081N0008X "Neuromuscular Medicine (Physical Medicine & Rehabilitation)"
* $NUCCProviderTaxonomy#2081P0004X "Spinal Cord Injury Medicine"
* $NUCCProviderTaxonomy#2081P0010X "Pediatric Rehabilitation Medicine"
* $NUCCProviderTaxonomy#2081P0301X "Brain Injury Medicine (Physical Medicine & Rehabilitation)"
* $NUCCProviderTaxonomy#2081P2900X "Pain Medicine (Physical Medicine & Rehabilitation)"
* $NUCCProviderTaxonomy#2081S0010X "Sports Medicine (Physical Medicine & Rehabilitation)"
* $NUCCProviderTaxonomy#208200000X "Plastic Surgery"
* $NUCCProviderTaxonomy#2082S0099X "Plastic Surgery Within the Head and Neck (Plastic Surgery)"
* $NUCCProviderTaxonomy#2082S0105X "Surgery of the Hand (Plastic Surgery)"
* $NUCCProviderTaxonomy#2083A0100X "Aerospace Medicine"
* $NUCCProviderTaxonomy#2083A0300X "Addiction Medicine (Preventive Medicine)"
* $NUCCProviderTaxonomy#2083B0002X "Obesity Medicine (Preventive Medicine)"
* $NUCCProviderTaxonomy#2083C0008X "Clinical Informatics"
* $NUCCProviderTaxonomy#2083P0011X "Undersea and Hyperbaric Medicine (Preventive Medicine)"
* $NUCCProviderTaxonomy#2083P0500X "Preventive Medicine/Occupational Environmental Medicine"
* $NUCCProviderTaxonomy#2083P0901X "Public Health & General Preventive Medicine"
* $NUCCProviderTaxonomy#2083S0010X "Sports Medicine (Preventive Medicine)"
* $NUCCProviderTaxonomy#2083T0002X "Medical Toxicology (Preventive Medicine)"
* $NUCCProviderTaxonomy#2083X0100X "Occupational Medicine"
* $NUCCProviderTaxonomy#2084A0401X "Addiction Medicine (Psychiatry & Neurology)"
* $NUCCProviderTaxonomy#2084A2900X "Neurocritical Care"
* $NUCCProviderTaxonomy#2084B0002X "Obesity Medicine (Psychiatry & Neurology)"
* $NUCCProviderTaxonomy#2084B0040X "Behavioral Neurology & Neuropsychiatry"
* $NUCCProviderTaxonomy#2084D0003X "Diagnostic Neuroimaging (Psychiatry & Neurology)"
* $NUCCProviderTaxonomy#2084F0202X "Forensic Psychiatry"
* $NUCCProviderTaxonomy#2084H0002X "Hospice and Palliative Medicine (Psychiatry & Neurology)"
* $NUCCProviderTaxonomy#2084N0008X "Neuromuscular Medicine (Psychiatry & Neurology)"
* $NUCCProviderTaxonomy#2084N0400X "Neurology"
* $NUCCProviderTaxonomy#2084N0402X "Neurology with Special Qualifications in Child Neurology"
* $NUCCProviderTaxonomy#2084N0600X "Clinical Neurophysiology"
* $NUCCProviderTaxonomy#2084P0005X "Neurodevelopmental Disabilities"
* $NUCCProviderTaxonomy#2084P0015X "Psychosomatic Medicine"
* $NUCCProviderTaxonomy#2084P0301X "Brain Injury Medicine (Psychiatry & Neurology)"
* $NUCCProviderTaxonomy#2084P0800X "Psychiatry"
* $NUCCProviderTaxonomy#2084P0802X "Addiction Psychiatry"
* $NUCCProviderTaxonomy#2084P0804X "Child & Adolescent Psychiatry"
* $NUCCProviderTaxonomy#2084P0805X "Geriatric Psychiatry"
* $NUCCProviderTaxonomy#2084P2900X "Pain Medicine (Psychiatry & Neurology)"
* $NUCCProviderTaxonomy#2084S0010X "Sports Medicine (Psychiatry & Neurology)"
* $NUCCProviderTaxonomy#2084S0012X "Sleep Medicine (Psychiatry & Neurology)"
* $NUCCProviderTaxonomy#2084V0102X "Vascular Neurology"
* $NUCCProviderTaxonomy#2085B0100X "Body Imaging"
* $NUCCProviderTaxonomy#2085D0003X "Diagnostic Neuroimaging (Radiology)"
* $NUCCProviderTaxonomy#2085H0002X "Hospice and Palliative Medicine (Radiology)"
* $NUCCProviderTaxonomy#2085N0700X "Neuroradiology"
* $NUCCProviderTaxonomy#2085N0904X "Nuclear Radiology"
* $NUCCProviderTaxonomy#2085P0229X "Pediatric Radiology"
* $NUCCProviderTaxonomy#2085R0001X "Radiation Oncology"
* $NUCCProviderTaxonomy#2085R0202X "Diagnostic Radiology"
* $NUCCProviderTaxonomy#2085R0203X "Therapeutic Radiology"
* $NUCCProviderTaxonomy#2085R0204X "Vascular & Interventional Radiology"
* $NUCCProviderTaxonomy#2085R0205X "Radiological Physics"
* $NUCCProviderTaxonomy#2085U0001X "Diagnostic Ultrasound"
* $NUCCProviderTaxonomy#208600000X "Surgery"
* $NUCCProviderTaxonomy#2086H0002X "Hospice and Palliative Medicine (Surgery)"
* $NUCCProviderTaxonomy#2086S0102X "Surgical Critical Care"
* $NUCCProviderTaxonomy#2086S0105X "Surgery of the Hand (Surgery)"
* $NUCCProviderTaxonomy#2086S0120X "Pediatric Surgery"
* $NUCCProviderTaxonomy#2086S0122X "Plastic and Reconstructive Surgery"
* $NUCCProviderTaxonomy#2086S0127X "Trauma Surgery"
* $NUCCProviderTaxonomy#2086S0129X "Vascular Surgery"
* $NUCCProviderTaxonomy#2086X0206X "Surgical Oncology"
* $NUCCProviderTaxonomy#208800000X "Urology"
* $NUCCProviderTaxonomy#2088F0040X "Female Pelvic Medicine and Reconstructive Surgery (Urology)"
* $NUCCProviderTaxonomy#2088P0231X "Pediatric Urology"
* $NUCCProviderTaxonomy#208C00000X "Colon & Rectal Surgery"
* $NUCCProviderTaxonomy#208D00000X "General Practice"
* $NUCCProviderTaxonomy#208G00000X "Thoracic Surgery (Cardiothoracic Vascular Surgery)"
* $NUCCProviderTaxonomy#208M00000X "Hospitalist"
* $NUCCProviderTaxonomy#208U00000X "Clinical Pharmacology"
* $NUCCProviderTaxonomy#208VP0000X "Pain Medicine"
* $NUCCProviderTaxonomy#208VP0014X "Interventional Pain Medicine"
* $NUCCProviderTaxonomy#209800000X "Legal Medicine (M.D./D.O.)"
