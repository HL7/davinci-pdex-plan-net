...
* Server systems claiming conformance to this guide **SHALL** meet the capability statement expectation requirements identified in the [Behavior: Capability Statements](artifacts.html#behavior-capability-statements) section of this guide and **SHALL** have a CapabilityStatement that has a CapabilityStatement.instantiates with containing the canonical URL of one or more CapabilityStatement resources from that section. 
